...
export const pipelineSteps: PipelineStep[] = [
  ...
  },
  {
    ...
    short: "текст со страниц",
    detail:
      "Отдельный парсер забирает и чистит текст со страниц поставщиков. Парсинг вне LLM — стабильнее и дешевле, чем отдавать весь сайт в модель.",
  },
  {
    id: "llm-extract",
    title: "LLM-extractor",
